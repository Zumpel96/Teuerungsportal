...
public static class EcontrolDataImport8010
{
    [FunctionName("EcontrolDataImport8010")]
    public static async Task Run(
        [TimerTrigger("0 0 1/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var dataExtractor = new EcontrolDataExtractor("8010", dbProducts, dbPrices);
        try
        {
