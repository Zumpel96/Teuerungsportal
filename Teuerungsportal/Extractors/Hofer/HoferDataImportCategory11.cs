...
public static class HoferDataImportCategory11
{
    [FunctionName("HoferDataImportCategory11")]
    public static async Task Run(
        [TimerTrigger("0 15 3/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var dataExtractor = new HoferDataExtractor("haushalt", dbProducts, dbPrices);
        try
        {
