...
public static class HoferDataImportCategory9
{
    [FunctionName("HoferDataImportCategory9")]
    public static async Task Run(
        [TimerTrigger("0 5 6/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var dataExtractor = new HoferDataExtractor("getranke", dbProducts, dbPrices);
        try
        {
