...
public static class HoferDataImportCategory7
{
    [FunctionName("HoferDataImportCategory7")]
    public static async Task Run(
        [TimerTrigger("0 55 5/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var dataExtractor = new HoferDataExtractor("tiefkuhlwaren", dbProducts, dbPrices);
        try
        {
