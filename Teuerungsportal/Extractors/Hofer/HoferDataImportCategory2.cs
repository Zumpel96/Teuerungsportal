...
public static class HoferDataImportCategory2
{
    [FunctionName("HoferDataImportCategory2")]
    public static async Task Run(
        [TimerTrigger("0 30 2/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var dataExtractor = new HoferDataExtractor("brot-geback", dbProducts, dbPrices);
        try
        {
