...
public static class DmDataImportCategory6
{
    [FunctionName("DmDataImportCategory6")]
    public static async Task Run(
        [TimerTrigger("0 15 0/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var dataExtractor = new DmDataExtractor("060000", dbProducts, dbPrices);
        try
        {
