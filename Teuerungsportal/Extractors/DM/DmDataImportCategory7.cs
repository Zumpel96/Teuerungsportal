...
public static class DmDataImportCategory7
{
    [FunctionName("DmDataImportCategory7")]
    public static async Task Run(
        [TimerTrigger("0 10 8/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var url = $"https://product-search.services.dmtech.com/at/search/crawl?pageSize=10000&allCategories.id=070000";
