...
public static class DmDataImportCategory3
{
    [FunctionName("DmDataImportCategory3")]
    public static async Task Run(
        [TimerTrigger("0 50 6/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var url = $"https://product-search.services.dmtech.com/at/search/crawl?pageSize=10000&allCategories.id=030000";
