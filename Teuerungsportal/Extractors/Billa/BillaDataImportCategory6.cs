...
public static class BillaDataImportCategory6
{
    [FunctionName("BillaDataImportCategory6")]
    public static async Task Run(
        [TimerTrigger("0 40 1/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var url = $"https://shop.billa.at/api/search/full?category=B2-6&includeSort[]=rank&sort=rank&pageSize=1000000";
