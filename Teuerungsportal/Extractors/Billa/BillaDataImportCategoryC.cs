...
public static class BillaDataImportCategoryC
{
    [FunctionName("BillaDataImportCategoryC")]
    public static async Task Run(
        [TimerTrigger("0 40 3/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var url = $"https://shop.billa.at/api/search/full?category=B2-C&includeSort[]=rank&sort=rank&pageSize=1000000";
