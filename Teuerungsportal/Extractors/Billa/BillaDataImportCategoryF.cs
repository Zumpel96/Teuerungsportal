...
public static class BillaDataImportCategoryF
{
    [FunctionName("BillaDataImportCategoryF")]
    public static async Task Run(
        [TimerTrigger("0 40 4/12 * * *")] TimerInfo myTimer,
        ...
        ILogger log)
    {
        ...
        var url = $"https://shop.billa.at/api/search/full?category=B2-F&includeSort[]=rank&sort=rank&pageSize=1000000";
