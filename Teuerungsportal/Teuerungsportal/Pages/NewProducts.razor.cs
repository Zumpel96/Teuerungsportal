...
public partial class NewProducts
{
    ...
    private async Task LoadCounts()
    {
        ...
        this.FilteredCount = await this.ProductService.GetAllProductCounts("/day");
    ...
    private async Task LoadProducts()
    {
        ...
        var newProducts = this.OrderType switch
                          {
                              OrderType.Grouped => await this.ProductService.GetNewProducts(
                                                                                            this.CurrentProductPage,
                                                                                            "store",
                                                                                            this.GetActiveStores()),
                              OrderType.Descending => await this.ProductService.GetNewProducts(
                                                                                               this.CurrentProductPage,
                                                                                               "descending",
                                                                                               this.GetActiveStores()),
                              _ => await this.ProductService.GetNewProducts(this.CurrentProductPage, "ascending", this.GetActiveStores()),
                          };
