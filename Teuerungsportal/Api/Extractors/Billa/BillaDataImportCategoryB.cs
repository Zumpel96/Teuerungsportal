...
public static class BillaDataImportCategoryB
{
    [FunctionName("BillaDataImportCategoryB")]
        ...
        ILogger log)
    {
        ...
        var url = $"https://shop.billa.at/api/search/full?category=B2-B&includeSort[]=rank&sort=rank&pageSize=1000000";
