...
public static class GetNumberOfProductsDailyForStore
{
    [FunctionName("GetNumberOfProductsForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/store/{storeId}/day")] HttpRequest req,
        [Sql(
                commandText: @"
