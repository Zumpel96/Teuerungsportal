...
{
    [FunctionName("GetProductPriceChanges")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "products/{productId}/prices/{page}")] HttpRequest req,
        [Sql(
                commandText: @"
                ...
                parameters: "@productId={productId},@page={page}",
