...
public static class GetNewProductsOrderedByAscending
{
    [FunctionName("GetNewProductsOrderedByAscendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/new/{page}/ascending/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
