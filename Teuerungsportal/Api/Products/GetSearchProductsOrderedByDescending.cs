...
public static class GetSearchProductsOrderedByDescending
{
    [FunctionName("GetSearchProductsOrderedByDescendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/search/{searchString}/{page}/descending/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
