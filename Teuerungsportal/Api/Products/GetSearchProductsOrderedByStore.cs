...
public static class GetSearchProductsOrderedByStore
{
    [FunctionName("GetSearchProductsOrderedByStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/search/{searchString}/{page}/store/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
