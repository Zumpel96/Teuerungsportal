...
public static class GetNumberOfProductsDaily
{
    [FunctionName("GetNumberOfProductsV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/total/day")] HttpRequest req,
        [Sql(
                commandText: @"
