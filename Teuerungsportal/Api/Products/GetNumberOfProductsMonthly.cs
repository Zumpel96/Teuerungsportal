...
public static class GetNumberOfProductsMonthly
{
    [FunctionName("GetNumberOfProductsMonthlyV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/total/month")] HttpRequest req,
        [Sql(
                commandText: @"
