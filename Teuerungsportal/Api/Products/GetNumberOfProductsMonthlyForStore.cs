...
public static class GetNumberOfProductsMonthlyForStore
{
    [FunctionName("GetNumberOfProductsMonthlyForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/store/{storeId}/month")] HttpRequest req,
        [Sql(
                commandText: @"
