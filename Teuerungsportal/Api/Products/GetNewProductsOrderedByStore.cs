...
public static class GetNewProductsOrderedByStore
{
    [FunctionName("GetNewProductsOrderedByStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/new/{page}/store/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
