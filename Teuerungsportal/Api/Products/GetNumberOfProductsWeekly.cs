...
public static class GetNumberOfProductsWeekly
{
    [FunctionName("GetNumberOfProductsWeeklyV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/total/week")] HttpRequest req,
        [Sql(
                commandText: @"
