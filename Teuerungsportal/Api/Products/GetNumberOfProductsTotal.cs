...
public static class GetNumberOfProductsTotal
{
    [FunctionName("GetNumberOfProductsTotalV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/total")] HttpRequest req,
        [Sql(
                commandText: @"
