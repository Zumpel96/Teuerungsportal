...
public static class GetStoreProductsOrderedByChange
{
    [FunctionName("GetStoreProductsOrderedByChangeV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/store/{storeId}/{page}/change")] HttpRequest req,
        [Sql(
                commandText: @"
