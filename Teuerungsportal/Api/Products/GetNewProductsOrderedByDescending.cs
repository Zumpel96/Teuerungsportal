...
public static class GetNewProductsOrderedByDescending
{
    [FunctionName("GetNewProductsOrderedByDescendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/new/{page}/descending/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
