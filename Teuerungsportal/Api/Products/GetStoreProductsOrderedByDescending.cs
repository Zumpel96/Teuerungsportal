...
public static class GetStoreProductsOrderedByDescending
{
    [FunctionName("GetStoreProductsOrderedByDescendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/store/{storeId}/{page}/descending")] HttpRequest req,
        [Sql(
                commandText: @"
