...
public static class GetNumberOfProductsTotalForStore
{
    [FunctionName("GetNumberOfProductsTotalForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/store/{storeId}")] HttpRequest req,
        [Sql(
                commandText: @"
