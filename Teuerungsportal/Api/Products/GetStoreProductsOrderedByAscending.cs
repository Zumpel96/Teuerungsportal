...
public static class GetStoreProductsOrderedByAscending
{
    [FunctionName("GetStoreProductsOrderedByAscendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/store/{storeId}/{page}/ascending")] HttpRequest req,
        [Sql(
                commandText: @"
