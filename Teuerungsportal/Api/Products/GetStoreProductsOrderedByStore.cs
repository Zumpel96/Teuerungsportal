...
public static class GetStoreProductsOrderedByStore
{
    [FunctionName("GetStoreProductsOrderedByStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/store/{storeId}/{page}/store")] HttpRequest req,
        [Sql(
                commandText: @"
