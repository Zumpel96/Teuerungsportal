...
public static class GetProductsWithoutCategorySearchPages
{
    [FunctionName("GetProductsWithoutCategorySearchPages")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "products/noCategory/search/{searchString}")] HttpRequest req,
        [Sql(
                commandText: @"
                                SELECT 
                                  COUNT(*) AS [count] 
