...
public static class GetSearchProductsOrderedByAscending
{
    [FunctionName("GetSearchProductsOrderedByAscendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/products/search/{searchString}/{page}/ascending/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
