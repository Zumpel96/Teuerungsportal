...
public static class GetNumberOfPriceChangesWeekly
{
    [FunctionName("GetNumberOfPriceChangesWeeklyV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/total/week")] HttpRequest req,
        [Sql(
                commandText: @"
