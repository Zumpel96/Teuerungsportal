...
public static class GetNumberOfPriceChangesMonthlyForFavorites
{
                                ...
                                (
                                  ...
                                  WHERE 
                                    [previousValue] IS NOT NULL
									                  AND [timestamp] >= CAST(GETDATE() - 29 AS DATE)
                                ) AS sub 
                              WHERE 
                                [sub].[storeId] = [s].[id]
                            ) AS [Count], 
    ...
    [FunctionName("GetNumberOfPriceChangesMonthlyForFavoritesV2")]
    public static async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "v2/prices/favorites/month")] HttpRequest req)
    {
