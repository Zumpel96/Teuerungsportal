...
public static class GetWorstPriceChanges
{
    [FunctionName("GetWorstPriceChangesV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/worst")] HttpRequest req,
        [Sql(
                commandText: @"
