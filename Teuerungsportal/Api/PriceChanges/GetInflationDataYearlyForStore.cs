...
public static class GetInflationDataYearlyForStore
{
    [FunctionName("GetInflationDataYearlyForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/inflation/store/{storeId}/year")] HttpRequest req,
        [Sql(
                commandText: @"
