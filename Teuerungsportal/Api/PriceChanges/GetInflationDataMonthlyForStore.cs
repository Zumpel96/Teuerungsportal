...
public static class GetInflationDataMonthlyForStore
{
    [FunctionName("GetInflationDataMonthlyForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/inflation/store/{storeId}/month")] HttpRequest req,
        [Sql(
                commandText: @"
