...
public static class GetInflationDataDailyForStore
{
    [FunctionName("GetInflationDataDailyForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/inflation/store/{storeId}/day")] HttpRequest req,
        [Sql(
                commandText: @"
