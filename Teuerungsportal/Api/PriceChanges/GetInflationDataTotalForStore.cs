...
public static class GetInflationDataTotalForStore
{
    [FunctionName("GetInflationDataTotalForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/inflation/store/{storeId}")] HttpRequest req,
        [Sql(
                commandText: @"
