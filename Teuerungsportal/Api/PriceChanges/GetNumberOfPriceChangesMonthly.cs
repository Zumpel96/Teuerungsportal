...
public static class GetNumberOfPriceChangesMonthly
{
    [FunctionName("GetNumberOfPriceChangesMonthlyV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/total/month")] HttpRequest req,
        [Sql(
                commandText: @"
