...
public static class GetNewPriceChangesOrderedByStore
{
    [FunctionName("GetNewPriceChangesOrderedByStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/{page}/store/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
