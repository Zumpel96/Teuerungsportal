...
public static class GetTotalPriceChangesChartDataForStore
{
    [FunctionName("GetTotalPriceChangesChartDataForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/chart/{storeId}")] HttpRequest req,
        [Sql(
                commandText: @"
