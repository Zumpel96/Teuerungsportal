...
public static class GetNewPriceChangesOrderedByDescending
{
    [FunctionName("GetNewPriceChangesOrderedByDescendingV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/{page}/descending/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
