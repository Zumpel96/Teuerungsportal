...
public static class GetNumberOfPriceChangesTotal
{
    [FunctionName("GetNumberOfPriceChangesTotalV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/total")] HttpRequest req,
        [Sql(
                commandText: @"
