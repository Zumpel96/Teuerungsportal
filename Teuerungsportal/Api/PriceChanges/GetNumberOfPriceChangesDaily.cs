...
public static class GetNumberOfPriceChangesDaily
{
    [FunctionName("GetNumberOfPriceChangesV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/total/day")] HttpRequest req,
        [Sql(
                commandText: @"
