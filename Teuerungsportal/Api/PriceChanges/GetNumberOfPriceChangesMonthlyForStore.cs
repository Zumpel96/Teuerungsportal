...
public static class GetNumberOfPriceChangesMonthlyForStore
{
    [FunctionName("GetNumberOfPriceChangesMonthlyForStoreV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/store/{storeId}/month")] HttpRequest req,
        [Sql(
                commandText: @"
