...
public static class GetNewPriceChangesOrderedByChange
{
    [FunctionName("GetNewPriceChangesOrderedByChangeV2")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v2/prices/{page}/change/{storeNames}")] HttpRequest req,
        [Sql(
                commandText: @"
