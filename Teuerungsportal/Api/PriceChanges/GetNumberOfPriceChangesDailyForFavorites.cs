...
public static class GetNumberOfPriceChangesDailyForFavorites
{
    ...
    [FunctionName("GetNumberOfPriceChangesForFavoritesV2")]
    public static async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "v2/prices/favorites/day")] HttpRequest req)
    {
