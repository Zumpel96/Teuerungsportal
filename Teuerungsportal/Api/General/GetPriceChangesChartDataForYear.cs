...
public static class GetPriceChangesChartDataForYear
{
    [FunctionName("GetPriceChangesChartDataForYear")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "prices/chart/year")] HttpRequest req,
        [Sql(
                commandText: @"
