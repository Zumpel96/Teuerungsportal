...
public static class GetStoreChartData
{
    [FunctionName("GetStoreChartData")]
    public static IActionResult Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "stores/{storeId}/chart")] HttpRequest req,
        [Sql(
                commandText: @"
